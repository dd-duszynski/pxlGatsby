export const contentPL = {
   ...
   footer: {
      ...
      links: [
         "http://printxl.pl/pdf/termsOfCooperation_PL.pdf",
         "http://printxl.pl/pdf/Instructions_PL.pdf",
      ],
   },
   navigation: {
      mainPageLink: "PL",
   ...
   products: {
      ...
      tag: {
         ...
         doubleSide: ["4+4","Zadruk dwustronny"],
         backlight: ["Light","Materiał do podświetleń"],
         stoplight: ["StopLight","Nieprzepuszczający światła"],
         nonFlammable: ["nonF","Materiał nieplany"],
         waterproof: ["nonW","Materiał wodoszczelny"]
      },
   },
   productPage: {
   ...
   blog: {
      ...
      tag: {
         ...
         products: [
            "Produkty",
            "Produkty - artykuł poświęcony jednemu z naszych produktów",
            "PL/blog/products",
         ],
         technology: [
            "Technologie",
            "Technologie - artykuł poświęcony jednej z naszych technologii",
            "PL/blog/technology",
         ],
         all: [
            "Wszystkie",
